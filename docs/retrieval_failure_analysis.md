...
- 분석 질문: 20개 (선정 조건의 합집합)

## 선정 조건

| 조건 | 질문 수 |
|---|---:|
| Simple 직접 근거 Top-5 실패 | 14 |
| Simple 직접 근거 Top-10 실패 | 9 |
| Simple 성공·Kiwi 실패 | 5 |
| Kiwi 성공·Simple 실패 | 4 |
| 복합 근거(`all`) | 2 |
...
| `query_document_vocabulary_gap` | R-005, R-007, R-008, R-010, R-012, R-014, R-017, R-022 |
| `repetitive_document_noise` | R-024, R-026, R-028 |
| `table_rendering` | R-015, R-018, R-020, R-030 |
| `title_section_underweighted` | R-006, R-011, R-019, R-023 |
