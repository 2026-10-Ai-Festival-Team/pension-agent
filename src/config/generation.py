...
class GenerationSettings:
    ...
    @classmethod
    def from_env(cls):
        value=cls(os.getenv("ENVIRONMENT","development"),os.getenv("GENERATOR_BACKEND","fake"),os.getenv("HCX_API_KEY",""),os.getenv("HCX_MODEL",""),os.getenv("HCX_BASE_URL",os.getenv("HCX_API_URL","")),float(os.getenv("HCX_TIMEOUT_SECONDS","30")),int(os.getenv("HCX_MAX_RETRIES","2")))
