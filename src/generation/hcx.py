    ...
    def generate(self, *, question, contexts, query_analysis):
        ...
        for attempt in range(self.config.max_retries+1):
            try:
                ...
                data=json.loads(body); content=data.get("message",{}).get("content") or data.get("choices",[{}])[0].get("message",{}).get("content")
                ...
                return GenerationResult(answer,cited,self.config.hcx_model,(time.perf_counter()-started)*1000,data.get("finish_reason"))
