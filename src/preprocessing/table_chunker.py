...
class TableChunker:
    ...
    def chunk_element(self, document: ParsedDocument, element: DocumentElement, section: Optional[str] = None) -> List[SearchChunk]:
        ...
        for index, group in enumerate(groups):
            ...
            chunks.append(SearchChunk(
                chunk_id=make_chunk_id(document.source_id, ChunkType.TABLE, [element.element_id], f"rows-{row_start}-{row_end}"),
                ...
                product_codes=document.product_codes, date_candidates=document.date_candidates, element_ids=[element.element_id],
